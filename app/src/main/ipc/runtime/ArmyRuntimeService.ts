...
import type { ArmySessionState, PendingStart } from "../methods/army";

export interface ArmyRuntimeServiceShape {
...
export class ArmyRuntimeService extends ServiceMap.Service<
  ArmyRuntimeService,
  ArmyRuntimeServiceShape
>()("main/ipc/runtime/ArmyRuntimeService") {}

export const makeArmyRuntimeService = (): ArmyRuntimeServiceShape => {
  let nextSessionId = 0;
  ...
  const service: ArmyRuntimeServiceShape = {
...
export const ArmyRuntimeServiceLive = Layer.effect(ArmyRuntimeService)(
  Effect.gen(function* () {
    const service = makeArmyRuntimeService();
