...
export interface EnvironmentStateStoreShape {
...
export class EnvironmentStateStore extends ServiceMap.Service<
  EnvironmentStateStore,
  EnvironmentStateStoreShape
>()("main/backend/environment/EnvironmentStateStore") {}

export const layer = Layer.effect(EnvironmentStateStore)(
  Effect.gen(function* () {
