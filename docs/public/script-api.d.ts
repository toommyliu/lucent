...
declare module "lucent/schema" {
const schemaType: unique symbol;
const brandType: unique symbol;
...
export function string(options?: MessageOptions): StringSchema;
export function number(options?: MessageOptions): NumberSchema;
export function boolean(options?: MessageOptions): Schema<boolean>;
export function date(options?: MessageOptions): DateSchema;
function nullSchema(options?: MessageOptions): Schema<null>;
function undefinedSchema(options?: MessageOptions): Schema<undefined>;
function unknownSchema(): Schema<unknown>;
function neverSchema(options?: MessageOptions): Schema<never>;
export {
  nullSchema as null,
...
function enumSchema<const V extends readonly (string | number)[]>(
  values: V,
  options?: MessageOptions,
): EnumSchema<V>;
export { enumSchema as enum };
export function object<const F extends Shape>(
  fields: F,
  options?: MessageOptions,
): ObjectSchema<F>;
export function array<S extends AnySchema>(
  element: S,
  options?: MessageOptions,
): ArraySchema<S>;
export function tuple<const S extends readonly AnySchema[]>(
  elements: S,
  options?: MessageOptions,
): TupleSchema<S>;
export function record<V extends AnySchema>(
  value: V,
  options?: MessageOptions,
...
export function union<const S extends readonly AnySchema[]>(
  members: S,
  options?: MessageOptions,
...
export function instanceOf<Args extends unknown[], T>(
...
export function jsonValue(): Schema<JsonValue>;
export function json<S extends AnySchema>(
  schema: S,
  options?: MessageOptions,
...
interface ScriptRuntimeApi {
  ...
  /** Opens a message dialog and waits until it is dismissed. */
    alert(message: string): Effect<void, never>;
  ...
  /** Opens a confirmation dialog. Canceling the dialog yields `false`. */
    confirm(message: string): Effect<boolean, never>;
...
interface ScriptAutoReloginApi {
    getDelayMs(): Effect<number, never>;
...
interface ScriptArmyApi {
    ...
    getPlayerNumber(): Effect<number | null, never>;
...
interface ScriptAurasApi {
    ...
    getAll(options?: AuraQueryOptions): Effect<readonly LiveAura[], never>;
...
interface ScriptAuthApi {
    ...
    getServers(): Effect<readonly LiveServer[], never>;
...
interface ScriptCombatApi {
    attack(target: MonsterQuery): Effect<boolean, never>;
...
interface ScriptPacketApi {
  ...
  /** @param encoding The client packet encoding. */
    sendToClient(packet: string, /** @defaultValue "string" */ encoding?: ClientPacketEncoding): Effect<boolean, never>;
  /** @param encoding The server packet encoding. */
    sendToServer(packet: string, /** @defaultValue "string" */ encoding?: 'string' | 'json'): Effect<boolean, never>;
}
...
interface ScriptPlayerApi {
  ...
  */
    ...
    rest(/** @defaultValue {} */ options?: RestOptions): Effect<boolean, never>;
...
interface ScriptPlayerFactionsApi {
    ...
    getAll(): Effect<readonly LiveFaction[], never>;
}
interface ScriptPlayerOutfitsApi {
  /** @param keepColors Whether to preserve the current colors. */
    ...
    getAll(): Effect<readonly LiveOutfit[], never>;
  /** @param keepColors Whether to preserve the current colors. */
...
interface ScriptQuestsApi {
  ...
  /** @param silent Whether to load the quests without opening their UI. */
    ...
    getAccepted(): Effect<readonly LiveQuest[], never>;
    getAll(): Effect<readonly LiveQuest[], never>;
...
interface ScriptShopApi {
    ...
    getAll(): Effect<readonly LiveItem[], never>;
    getCurrent(): Effect<LiveShop | null, never>;
...
interface ScriptEffectPipeable {
  pipe<A>(this: A): A;
...
type ClientPacketEncoding = PacketEncoding | "xml";
interface CombatKillOptions {
   ...
   * @defaultValue 150
   */
  readonly skillInterval?: DurationInput;
  /**
...
type ClientPacket = { readonly command: string; readonly direction: 'client'; readonly params: readonly string[]; readonly raw: string; readonly encoding: 'string' | 'json'; };
type ServerPacket = { readonly command: string; readonly data: unknown; readonly direction: 'server'; readonly raw: string; readonly encoding: 'string' | 'json'; };
type ExtensionPacket = { readonly command: string; readonly data: unknown; readonly direction: 'extension'; readonly raw: string; readonly encoding: 'string' | 'json'; };
...
type CombatProfileMessageTrigger = { readonly skill: 0 | 1 | 2 | 3 | 4 | 5; readonly messageIncludes: string; readonly source: 'any' | 'animation' | 'aura'; readonly animStr?: string; readonly cooldownMs?: number; } | { readonly skill: 0 | 1 | 2 | 3 | 4 | 5; readonly animStr: string; readonly source: 'any' | 'animation' | 'aura'; readonly messageIncludes?: string; readonly cooldownMs?: number; };
