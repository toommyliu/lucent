...
<p class="source-reference">Defined in <a class="source-reference__link" href="https://github.com/toommyliu/lucent/blob/main/app/src/renderer/apps/game/scripting/ScriptApi.ts#L738" aria-label="Open source: app/src/renderer/apps/game/scripting/ScriptApi.ts:738" title="app/src/renderer/apps/game/scripting/ScriptApi.ts:738" target="_blank" rel="noreferrer"><code class="source-reference__path">ScriptApi.ts:738</code></a></p>
