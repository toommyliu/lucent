...
<p class="source-reference">Defined in <a class="source-reference__link" href="https://github.com/toommyliu/lucent/blob/main/app/src/renderer/apps/game/scripting/ScriptApi.ts#L669" aria-label="Open source: app/src/renderer/apps/game/scripting/ScriptApi.ts:669" title="app/src/renderer/apps/game/scripting/ScriptApi.ts:669" target="_blank" rel="noreferrer"><code class="source-reference__path">ScriptApi.ts:669</code></a></p>
