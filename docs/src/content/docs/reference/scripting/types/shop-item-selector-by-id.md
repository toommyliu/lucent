...
<p class="source-reference">Defined in <a class="source-reference__link" href="https://github.com/toommyliu/lucent/blob/main/packages/game/src/item.ts#L106" aria-label="Open source: packages/game/src/item.ts:106" title="packages/game/src/item.ts:106" target="_blank" rel="noreferrer"><code class="source-reference__path">item.ts:106</code></a></p>
