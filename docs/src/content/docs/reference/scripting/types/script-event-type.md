...
```ts
type ScriptEventType = "connection" | "debug" | "packet" | "join-map" | "item-drop" | "quest-complete" | "monster-death" | "monster-respawn" | "player-death" | "players-changed" | "aura-added" | "aura-removed" | "anti-counter-start" | "anti-counter-end" | "player-location" | "update-message" | "zone"
```
