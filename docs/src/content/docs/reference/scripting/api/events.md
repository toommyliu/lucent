...
| `item-drop` | <code>{ item: ItemSnapshot }</code> |
...
```ts
api.events.on(query: EventSelector | undefined, handler: (event: ScriptEvent) => ScriptCallbackResult): Effect.Effect<() => void, never, never>
```

| Name | Type | Required | Description |
| --- | --- | --- | --- |
| `query` | <a href="/reference/scripting/types/event-selector/" data-script-type="event-selector"><code>EventSelector</code></a> \| `undefined` | <span class="required-mark" role="img" aria-label="Required"></span> |  |
| `handler` | (`event`: <a href="/reference/scripting/types/script-event/" data-script-type="script-event"><code>ScriptEvent</code></a>) =&gt; <a href="/reference/scripting/types/script-callback-result/" data-script-type="script-callback-result"><code>ScriptCallbackResult</code></a> | <span class="required-mark" role="img" aria-label="Required"></span> |  |
...
```ts
api.events.once(selector?: EventSelector | undefined, options?: TriggeredWaitOptions<E, R> | undefined): Effect.Effect<ScriptEvent | null, E, Exclude<R, Scope.Scope>>
```
...
<div data-api-copy-call="api.events.stream();" hidden></div>

```ts
api.events.stream(selector?: S): Stream.Stream<ScriptEventForSelector<S>>
```
...
**Returns:** `Stream`.`Stream`&lt;<a href="/reference/scripting/types/script-event-for-selector/" data-script-type="script-event-for-selector"><code>ScriptEventForSelector</code></a>&lt;`S`&gt;&gt;
