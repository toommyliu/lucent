...
| `options` | <a href="/reference/scripting/types/army-equip-set-options/" data-script-type="army-equip-set-options"><code>ArmyEquipSetOptions</code></a> |  |  |

**Yields:** `void`

**Errors:** <a href="/reference/scripting/types/army-error/" data-script-type="army-error"><code>ArmyError</code></a>
...
**Errors:** `E` \| <a href="/reference/scripting/types/army-error/" data-script-type="army-error"><code>ArmyError</code></a>
...
**Yields:** <a href="/reference/scripting/types/army-session/" data-script-type="army-session"><code>ArmySession</code></a> \| `null`
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| `target` | <a href="/reference/scripting/types/monster-query/" data-script-type="monster-query"><code>MonsterQuery</code></a> | <span class="required-mark" role="img" aria-label="Required"></span> |  |
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| `plan` | <a href="/reference/scripting/types/army-loop-taunt-plan/" data-script-type="army-loop-taunt-plan"><code>ArmyLoopTauntPlan</code></a> | <span class="required-mark" role="img" aria-label="Required"></span> | The ordered target priority groups every participant runs. |

**Yields:** <a href="/reference/scripting/types/army-loop-taunt-handle/" data-script-type="army-loop-taunt-handle"><code>ArmyLoopTauntHandle</code></a>

**Errors:** <a href="/reference/scripting/types/army-loop-taunt-error/" data-script-type="army-loop-taunt-error"><code>ArmyLoopTauntError</code></a>
...
| `action` | `Effect`.`Effect`&lt;`A`, `E`&gt; | <span class="required-mark" role="img" aria-label="Required"></span> |  |
| `options` | <a href="/reference/scripting/types/army-run-step-options/" data-script-type="army-run-step-options"><code>ArmyRunStepOptions</code></a> |  |  |
...
**Yields:** <a href="/reference/scripting/types/army-session/" data-script-type="army-session"><code>ArmySession</code></a>
