...
| [`lucent/schema`](/reference/scripting/schema/) | Validate and transform data with reusable schemas. |
| [`lucent/http`](/reference/scripting/http/) | Sends HTTP/HTTPS requests. |
