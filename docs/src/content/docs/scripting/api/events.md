...
| --- | --- | --- | --- |
| `query` | <a href="/scripting/types/event-selector/" data-script-type="event-selector"><code>EventSelector</code></a> \| `undefined` | <span class="required-mark" role="img" aria-label="Required"></span> |  |
| `handler` | (`event`: <a href="/scripting/types/script-event/" data-script-type="script-event"><code>ScriptEvent</code></a>) =&gt; <a href="/scripting/types/script-callback-result/" data-script-type="script-callback-result"><code>ScriptCallbackResult</code></a> | <span class="required-mark" role="img" aria-label="Required"></span> |  |
...
**Returns:** `Stream`.`Stream`&lt;<a href="/scripting/types/script-event-for-selector/" data-script-type="script-event-for-selector"><code>ScriptEventForSelector</code></a>&lt;`S`&gt;&gt;
